...
<head>
    ...
    <title>Tạo Tài Khoản Quốc Duy ID</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", sans-serif; -webkit-font-smoothing: antialiased; }
        body { background-color: #ffffff; color: #1d1d1f; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; padding: 30px 20px; }
        ...
        input[type="text"], input[type="email"], input[type="password"] { width: 100%; height: 50px; padding: 0 16px; font-size: 15px; border: 1px solid #d2d2d7; border-radius: 12px; outline: none; transition: 0.2s; }
        input:focus { border-color: #0071e3; box-shadow: 0 0 0 4px rgba(0,113,227,0.15); }
        .btn-submit { width: 100%; height: 50px; background: #0071e3; color: #fff; border: none; border-radius: 980px; font-size: 16px; font-weight: 500; cursor: pointer; transition: 0.2s; margin-top: 10px; }
        .btn-submit:hover { background: #0077ed; transform: scale(1.01); }
        .options-links { margin-top: 24px; font-size: 14px; }
...
<body>
    <div class="card">
        ...
        <h1>Tạo Quốc Duy ID</h1>
        <p class="subtitle">Một tài khoản duy nhất cho toàn bộ hệ thống Quốc Duy Store</p>
