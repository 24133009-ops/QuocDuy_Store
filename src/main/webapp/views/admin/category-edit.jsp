...
<head>
    ...
    <title>Chỉnh Sửa Danh Mục - Quốc Duy Admin</title>
    <style>
        :root {
            --bg-color: #f5f5f7;
        ...
        * {
        ...
        /* Container Preview Ảnh Hiện Tại */
        .preview-box {
            display: flex;
            align-items: center;
            gap: 16px;
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Cập nhật thông tin danh mục thiết bị #${cate.categoryId}</p>
        </div>
            ...
            <form action="<c:url value='/admin/category/update'/>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="preview-box">
                        <c:choose>
                            <c:when test="${not empty cate.images && cate.images.startsWith('http')}">
                                <img class="current-img" src="${cate.images}" alt="${cate.categoryname}" />
                            </c:when>
                            <c:when test="${not empty cate.images}">
                                <img class="current-img" src="<c:url value='/image?fname=${cate.images}'/>" alt="${cate.categoryname}" />
                            </c:when>
                            <c:otherwise>
                                <div class="current-img" style="display: flex; align-items: center; justify-content: center; background: #f2f2f7; color: #86868b; font-size: 11px;">Chưa có ảnh</div>
                            </c:otherwise>
                        </c:choose>
                        <div class="preview-info">
                            <b>${cate.categoryname}</b>
                            <span>Đang sử dụng hiển thị trên toàn hệ thống cửa hàng</span>
                        </div>
                    </div>
                </div>

                <div class="form-group">
                    <label for="images">Đổi đường dẫn ảnh (URL Online)</label>
                    <input type="text" id="images" name="images" value="${cate.images}" placeholder="https://images.unsplash.com/...">
                    <div class="hint">Nhập URL ảnh mới nếu muốn thay đổi liên kết trực tiếp</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="hint">Định dạng hỗ trợ: PNG, JPG, WebP (bỏ trống nếu muốn giữ nguyên ảnh hiện tại)</div>
                </div>
